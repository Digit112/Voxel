...
namespace sgl {
	...
	public:
		...
		expr<RGBAD> render_prop(app_handle* ah, vecd3 origin, vecd3 dir, void* state, double delta_time);
		...
		expr<RGBAD> (*render)(app_handle* ah, vecd3 origin, vecd3 dir, void* state, double delta_time,
